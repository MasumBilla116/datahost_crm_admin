...
import MySinglePagination from "../MySinglePagination";

const MRI_Single_Uploader=({onSubmitUploads,selectLoading})=>{
    ...
    const handleChange = (e) => {
     ...
     setImage(imagesArray);
      ...
      const onUpload=async(e)=> {
        ...
        setPending(true);
        await http.post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/uploader/upload`,data)
        .then((res)=>{
    ...
    const get_uploads_files = useCallback(async ()=>{
      let isSubscribed = true;
      setLoading(true)
      await http.post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/uploader/upload`,{action: "getAllUploadedFiles" })
      .then((res)=>{
        if(isSubscribed){
        ...
        <div className="col-12">
          <div className="card shadow">
            ...
            <Form>
                ...
                {
                  !loading &&  <MySinglePagination submit={storeUploadIds}  Items={images} />
                }
...
export default MRI_Single_Uploader;
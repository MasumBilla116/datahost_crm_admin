...
export default function SubLocationTree({item, subActionBtn, subEditBtn, actionBtn}) {
            ...
            <ul>
                ...
                <li style={(subItem.status == 0) ? {borderLeft : "2px solid red"} : {}}> 
                    <details open>
                       ...
                       {subItem?.children_recursive?.length != 0 && (
                          <SubLocationTree item={subItem} subActionBtn={subActionBtn} subEditBtn={subEditBtn} actionBtn={actionBtn}/>
                        )} 
                    </details>
                </li>
                }

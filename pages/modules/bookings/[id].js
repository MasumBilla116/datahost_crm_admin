...
function updateBooking({ query }) {
  ...
  useEffect(() => {
    AllRoomsData();
  }, [AllRoomsData,bookingGrp?.date_from,bookingGrp?.date_to]);
...
// setCustomerBooking
        ...
        setCustomerBooking((prev) => ({
          ...
          const _subtotal = result?.total_amount
        ...
        setBookingGrp((prev) => ({
          ...
          advance_paid: result?.advance_payment, 
        }));
                        ...
                        <div className="card-body">
                          ...
                          <div className="row">
                            <Form.Group className="mb-2 col-6">
                              ...
                              <Select2
                                maxMenuHeight={175}
                                defaultValue={selectedPromoOption}
                                options={[
                                  { value: '', label: "None" },
                                  ...offers.map(({ id, name }) => ({
                                    value: id,
                                  ...
                                  <table className='table table-price-details'>
                                    <tbody>
                                      ...
                                      <tr style={{ borderBottom: '1px solid black', borderTop: 'hidden' }}>
                                        ...
                                        <td>Discount ({promoInfo?.amount ?? 0} + {bookingGrp?.additional_discount ?? 0})</td>
                                        <td>:</td>
                                        {/* <td>{parseFloat(promoInfo?.amount) + parseFloat(bookingGrp?.additional_discount)}</td> */}
                                        <td>
                                          ${isNaN(
                                            parseFloat(promoInfo?.amount ?? 0) +
                                            parseFloat(
                                      ...
                                      <tr style={{ borderTop: 'hidden', borderBottom: '1px solid black' }}>
                                        <td>Advance Paid</td>
                                        <td>:</td>
                                        <td>${bookingGrp?.advance_paid}</td>
                                      </tr>
                                      <tr>
                                        <td>Total Payable</td>
                                        <td>:</td>
                                        <td>${(bookingGrp?.net_amount - bookingGrp?.advance_paid).toFixed(2)}</td>
                                      </tr>

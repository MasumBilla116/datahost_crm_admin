...
const CreateInvoice = () => {
  ...
  const getAllCustomer = useCallback(async () => {
    ...
    await http
      ...
      .then((res) => {
        ...
        setInvoice(prev=>({
          ...prev,
          booking_id: res?.data?.data[0]?.booking_master_id,
          customer_id: res?.data?.data[0]?.id
        }));
      });
  }, [invoice?.room_id]);
  ...
  useEffect(() => {
    getAllCustomer();
  }, [getAllCustomer, invoice?.room_id]);
                          ...
                          <>
                            ...
                            <Form.Group className="col-md-4">
                              ...
                              <Form.Control
                                ...
                                defaultValue={
                                  customers
                                    ? `${customers.first_name} ${customers.last_name} - ${customers.mobile}`
                                    : ''
                                }
                                readOnly
                              />

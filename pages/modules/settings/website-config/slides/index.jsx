...
const CreateForm = ({ onSubmit, loading, validated }) => {
  ...
  const setFilesData=(data)=>{
    ...
    let dataset = { ...slides, action: "createSlides" }
          ...
          <Form validated={validated}>
            ...
            <Form.Group className="mb-3" controlId="formBasicDesc" >
              ...
              {loading ? (
                ...
                <Select defaultValue=""  name="slider_id" onChange={handleChange}>
            ...
            {/* Choose File Button */}
            <FileSelectButton handleShow={handleShow} files={slides} removePhoto={removePhoto}/>
...
//Update component
const EditForm = ({ onSubmit, slides_id, pending, validated }) => {
    ...
    const fetchSliderData = useCallback(async () => {
        ...
        setLoading(true)
        await http.post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/website/slide`, { action: "getSlidesInfo", slides_id:slides_id })
            .then((res) => {
                if (isSubscribed) {
                    setSlides(prev => ({
                        ...prev,
                        slider_id:res?.data?.data?.slider_id,
  ...
  const setFilesData=(data)=>{
    ...
    let dataset = { ...slides,action: "updateSlides" }
     ...
     <MRIfileManagerRender setIds={setIds} setFilesData={setFilesData}   render={(show,handleClose,uploadIds,selecteLoading,handleShow,files)=>(<>
      ...
      <Form.Group className="mb-3" controlId="formBasicDesc" >
        ...
        {loading ? (
          ...
          <Select defaultValue={slides.slider_id} name="slider_id" onChange={handleChange}>
         {/* <option value="" disabled>Select..</option> */}
      ...
      <Form.Group controlId="formBasicDesc" className="mt-3">
          ...
          <Form.Control as="textarea" rows={5} 
            ...
            name='description'
            onChange={handleChange}
            defaultValue={slides.description}
          />
      </Form.Group>
...
//Delete component
const DeleteComponent = ({ onSubmit, slides_id, pending }) => {
    ...
    let dataset = { slides_id, action: "deleteSlides" }
...
const ManageSliders = () => {
    ...
    const [slides_id, setSlidesId] = useState(null)
                ...
                <div className="col-12 p-xs-2">
                    <div className="card shadow">
                        ...
                        <div className="d-flex border-bottom title-part-padding align-items-center">
                            <div>
                                <h4 className="card-title mb-0">All Slides</h4>
                            </div>
                            <div className="ms-auto flex-shrink-0">
                                ...
                                <Modal dialogClassName="modal-lg" show={showUpdateModal} onHide={handleExit}>
                                    ...
                                    <Modal.Body>
                                        <EditForm onSubmit={updateForm} slides_id={slides_id} pending={pending} validated={validated}
                                        />
                                    </Modal.Body>
                                </Modal>
                                ...
                                <Modal show={showDeleteModal} onHide={handleExitDelete}>
                                    ...
                                    <DeleteComponent onSubmit={handleDelete} slides_id={slides_id} pending={pending} />
                                </Modal>

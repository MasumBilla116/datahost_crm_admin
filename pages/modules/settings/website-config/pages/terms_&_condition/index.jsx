...
const TermsCondition = () => {
    ...
    const fetchSectionData = useCallback(async () => {
        ...
        setLoading(true);
        await http
            .post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/website/terms_condition`, {
                action: "getTermsConditionInfo",
            })
    ...
    const onUpload = async (e) => {
        ...
        setPending(true);
        await http
            .post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/website/terms_condition`, body)
            .then((res) => {
                if (isSubscribed) {

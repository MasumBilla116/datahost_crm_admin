...
const ReturnRefund = () => {
    ...
    const fetchSectionData = useCallback(async () => {
        ...
        setLoading(true);
        await http
            .post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/website/return_refund`, {
                action: "getReturnRefundInfo",
            })
    ...
    const onUpload = async (e) => {
        ...
        setPending(true);
        await http
            .post(`${process.env.NEXT_PUBLIC_SAPI_ENDPOINT}/app/website/return_refund`, body)
            .then((res) => {
                if (isSubscribed) {

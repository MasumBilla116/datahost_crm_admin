                            ...
                            <Form onSubmit={submitForm} id="customerForm" noValidate validated={validated}>
                                ...
                                <div className="card-body">
                                    ...
                                    <Row className="mb-3">
                                        ...
                                        <Form.Group as={Col} md="4">
                                            ...
                                            {generalLedger?.sector_head && (
                                                <>
                                                    <Select2
                                                        options={accountHead?.map(({ label, value }) => ({ value, label, name: "sector_head" }))}
                                                        value={accountHead.find(option => option.value === generalLedger.sector_head)}
                                                        onChange={(e) => {
                                                            setGeneralLedger((prev) => ({
                                                                ...prev,
                                                                sector_head: e.value
                                        ...
                                        <Form.Group as={Col} md="4">
                                            ...
                                            {loading ? (
                                                ...
                                                <Select
                                                value={generalLedger.sector_id} 
                                                onChange={(e) => setGeneralLedger(prev => ({
                                    ...
                                    <Row className="w-50 m-auto p-4">
                                        <Button variant="success" type="submit">Update Ledger</Button>
                                    </Row>

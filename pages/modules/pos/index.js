    ...
    return (
        ...
        <div className="col-lg-4 col-md-6 p-xs-2">
          <div className="card mb-xs-1">
            <div className="card-body dashboard-min-card">
              <div className="d-flex no-block">
                <div className="me-3 align-self-center">
                  <span className="lstick d-inline-block align-middle" />
                  <img src="/assets/images/icon/income.png" alt="Income" className="white-image" />
                </div>
                <div className="align-self-center">
                  <h6 className="dashboard-min-heading mt-2 mb-0">Monthly Income</h6>
                  <h2 className="dashboard-min-heading">{MonthlyIncome}</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-lg-4 col-md-6 p-xs-2">
          <div className="card mb-xs-1">
            <div className="card-body dashboard-min-card2">
              <div className="d-flex no-block">
                <div className="me-3 align-self-center">
                  <span className="lstick d-inline-block align-middle" />
                  <img src="/assets/images/icon/assets.png" alt="Income" className="white-image" />
                </div>
                <div className="align-self-center">
                  <h6 className="dashboard-min-heading mt-2 mb-0">Food Category</h6>
                  <h2 className="dashboard-min-heading">{TotalCount.restaurantCategory}</h2>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card mb-xs-1">
            <div className="card-body dashboard-min-card">
              <div className="d-flex no-block">
                <div className="me-3 align-self-center">
                  <span className="lstick d-inline-block align-middle" />
                  <img src="/assets/images/icon/staff.png" alt="Income" className="white-image" />
                </div>
                <div className="align-self-center">
                  <h6 className="dashboard-min-heading mt-2 mb-0">Total Foods</h6>
                  <h2 className="dashboard-min-heading">{TotalCount.foods}</h2>
                </div>
              </div>
            </div>
          </div>
